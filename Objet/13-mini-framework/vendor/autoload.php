<?php
    ...
    // En POO, spl_autoload_register a besoin du nom de la classe et de la methode a executer. On passe donc un array.

    // Attention, notre methode doit OBLIGATOIREMENT etre static.